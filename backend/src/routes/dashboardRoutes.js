...
router.get('/approver', protect, requireRole('approver_l1', 'approver_l2', 'approver_l3', 'approver_l4', 'approver_l5', 'approver_l6', 'admin'), dashboardController.getApproverDashboard);
router.get('/admin', protect, requireRole('admin'), dashboardController.getAdminDashboard);
router.get('/audit-logs', protect, dashboardController.getAuditLogs);
