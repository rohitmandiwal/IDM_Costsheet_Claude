      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center mb-8">
          <div className="flex items-center gap-4 text-sm">
            <span className="px-3 py-1.5 rounded-full bg-blue-600 text-white font-semibold">1</span>
            <span className="font-semibold text-blue-600">Fetch PRs</span>
          </div>
    ...
    return (
        <div
            ...
            className={`cursor-pointer p-4 border rounded-lg transition-all ${
                selected ? 'border-blue-600 bg-blue-50/50 ring-2 ring-blue-200' : 'border-gray-300 hover:border-gray-400'
            }`}
        >
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 mt-1">
                <div className={`w-4 h-4 rounded-full border-2 ${selected ? 'border-blue-600 bg-blue-600' : 'border-gray-400'}`}>
